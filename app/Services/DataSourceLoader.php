...
class DataSourceLoader
{
    ...
    public function load(string $dataSource, string $tenantId): Collection
    {
        ...
        // Dispatch to the appropriate model/table based on data source name.
        // Each data source maps to a dedicated read-only query.
     ...
     * In production, replace with actual model query.
     *
