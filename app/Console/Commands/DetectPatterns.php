...
class DetectPatterns extends Command
{
    ...
    {
        // Per-feature execution count, capped at 500
        // Then aggregate by pipeline_signature across opted-in features
    ...
    {
        // Risk is assessed based on pattern characteristics.
        // A more sophisticated implementation would inspect the
        // operator composition of the candidate pattern.
        // For now: return 'medium' as default (requires dev review).
        return 'medium';
    }
}
