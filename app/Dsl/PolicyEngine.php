...
class PolicyEngine
{
    ...
    public function stage2(FeatureConfig $feature, string $executionTenantId): array
    {
        ...
        $concurrent = \App\Models\FeatureExecution::where('tenant_id', $tenant->id)
    ...
    {
        // Tier 1: read-only, filter + sort only — no writes, no scheduling
        // Tier 2: aggregation, alerting, scheduling
        // Tier 3: external integrations or novel data sources
    ...
    private function estimateDailyExecutions(string $expression): int
    {
        ...
        // Count occurrences per day based on minute/hour fields
