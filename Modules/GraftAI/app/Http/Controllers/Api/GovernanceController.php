...
namespace Modules\GraftAI\Http\Controllers\Api;
...
use Modules\GraftAI\Services\PromotionPipeline;
 ...
 * POST /api/governance/candidates/{id}/revert   — Revert approved/rejected to pending
 * POST /api/governance/candidates/{id}/promote  — Promote an approved candidate
 * POST /api/governance/candidates/{id}/rollback — Roll back a promoted candidate
